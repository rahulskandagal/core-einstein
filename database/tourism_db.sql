...
('Bali Paradise', 'Beach', 'Indonesia', 'Crystal clear waters and vibrant culture.', 'Experience the spiritual essence and tropical beauty of Bali. From the lush jungles of Ubud to the stunning beaches of Seminyak, Bali offers a diverse range of experiences for every traveler.', 'April to October', 1200.00, 'bali_main.jpg', 1, 4.8),
('Swiss Alps', 'Mountain', 'Switzerland', 'Snowy peaks and breathtaking landscapes.', 'The Swiss Alps represent the pinnacle of mountain beauty. Enjoy skiing in Zermatt, hiking in Grindelwald, or simply taking in the majestic views of the Matterhorn.', 'December to March (Skiing), June to September (Hiking)', 2500.00, 'swiss_main.jpg', 1, 4.9),
('Paris Lights', 'City', 'France', 'The city of love, fashion, and art.', 'Paris is a global center for art, fashion, gastronomy, and culture. Its 19th-century cityscape is crisscrossed by wide boulevards and the River Seine.', 'April to June, October to early November', 1800.00, 'paris_main.jpg', 1, 4.7),
('Santorini', 'Beach', 'Greece', 'Iconic white buildings and blue domes.', 'Santorini is one of the Cyclades islands in the Aegean Sea. It was devastated by a volcanic eruption in the 16th century BC, forever shaping its rugged landscape.', 'September to October', 2100.00, 'santorini_main.jpg', 0, 4.9);
